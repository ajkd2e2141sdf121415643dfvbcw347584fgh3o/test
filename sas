...
local config = {
    Weapon = {"Katana", "Greatsword", "DualGun", "Guitar"}, -- อาวุธที่ต้องการ
    Perk = {"Healer", "DoubleDmg", "Vampire"}, -- Perk ที่ต้องการ  
    Paly = "Replay", -- "Replay" หรือ "Back"
    Map = "School", -- แมพที่ต้องการ
    Difficult = "Nightmare" -- "Normal", "Hard", "Nightmare"
}
